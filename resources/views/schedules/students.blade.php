...
@section('title', 'Danh sách học sinh - ' . $scheduleData->class_name)

@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>Danh sách học sinh: {{ $scheduleData->class_name }} ({{ $scheduleData->class_code }})</h3>
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">{{ $scheduleData->class_name }}</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                <div class="d-flex justify-content-between mg-3">
                    <h3>dsds</h3>
                    <!-- Nút mở modal -->
                    <button class="btn btn-success btn-lg" data-id="{{ $scheduleData->id }}" onclick="openModal(this)">Thêm
                        học sinh</button>
                    <!-- Modal -->
                    <div class="modal" id="modal" onclick="closeModal(event)">
                        <div class="modal-content" onclick="event.stopPropagation()">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-submit" id="submitButton" onclick="saveForm(event)">Thêm học
                                    sinh</button>
                            </div>
                        </div>
                    </div>

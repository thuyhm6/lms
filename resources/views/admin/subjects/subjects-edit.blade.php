        ...
        <div class="main-content-wrap">
            ...
            <div class="flex items-center flex-wrap justify-between gap20 mb-5">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Sửa môn học</div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="bg-white rounded p-3 d-flex flex-wrap justify-between align-items-end">
                            ...
                            <select name="teacher_permission">
                                ...
                                @foreach ($teachers as $teacher)
                                    <option value="{{ $teacher->user_id }}"
                                        {{ old('teacher_permission', $subject->teacher_permission) == $teacher->user_id ? 'selected' : '' }}>
                                        {{ $teacher->full_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <fieldset class="my-3 col-lg-6 col-md-12 p-3">
                            ...
                            <select name="publish_status">
                                <option value="1"
                                    {{ old('publish_status', $subject->publish_status) == '1' ? 'selected' : '' }}>Duyệt
                                </option>
                                <option value="0"
                                    {{ old('publish_status', $subject->publish_status) == '0' ? 'selected' : '' }}>Chưa
                                    duyệt</option>
                            </select>
                        ...
                        <div class="mt-4 col-lg-12 col-md-12 p-3">
                            <button type="submit" class="tf-button w-full">Cập nhật môn học</button>
                        </div>
                    </div>
                </div>
                        ...
                        <fieldset class="my-3 col-lg-12 col-md-12 p-3">
                            ...
                            <div class="upload-image row">
                                ...
                                <div class="item p-2 col-lg-12 col-md-12" id="imgpreview"
                                    ...
                                    <img src="{{ $subject->image ? asset($subject->image) : '' }}" class="effect8 rounded"
                                        alt="">
                                </div>
                                @error('image')
                                    <p class="text-danger"> {{ $message }}</p>

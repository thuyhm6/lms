        ...
        <div class="main-content-wrap">
            ...
            <div class="flex items-center flex-wrap justify-between gap20 mb-5">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">Chỉnh sửa khóa học</div>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="bg-white rounded p-3 d-flex flex-wrap justify-between align-items-end">
                        ...
                        <fieldset class="my-3 col-lg-6 col-md-12 p-3">
                            ...
                            <select name="is_visible">
                                <option value="1"
                                    {{ old('is_visible', $course->is_visible) == '1' ? 'selected' : '' }}>Hiển thị</option>
                                <option value="0"
                                    {{ old('is_visible', $course->is_visible) == '0' ? 'selected' : '' }}>Ẩn</option>
                            </select>
                        </fieldset>
                        ...
                        <fieldset class="my-3 col-lg-6 col-md-12 p-3">
                            ...
                            <select name="display_on_homepage">
                                <option value="1"
                                    {{ old('display_on_homepage', $course->display_on_homepage) == '1' ? 'selected' : '' }}>
                                    Hiện</option>
                                <option value="0"
                                    {{ old('display_on_homepage', $course->display_on_homepage) == '0' ? 'selected' : '' }}>
                                    Không</option>
                            </select>
                        </fieldset>

                        <div class="mt-4 col-lg-12 col-md-12 p-3">
                            <button type="submit" class="tf-button w-full">Cập nhật khóa học</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded p-3 d-flex flex-wrap justify-between align-items-end">
                        ...
                        <fieldset class="my-3 col-lg-12 col-md-12 p-3">
                            ...
                            <div class="upload-image row">
                                ...
                                <div class="item p-2 col-lg-12 col-md-12" id="imgpreview"
                                    style="{{ $course->image ? '' : 'display:none' }}">
                                    <img src="{{ $course->image ? asset($course->image) : '' }}" class="effect8 rounded"
                                        alt="">
                                </div>
                                @error('image')
                                    <p class="text-danger"> {{ $message }}</p>
